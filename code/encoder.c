...
void EncoderInit(void){
    ...
    encoder_dir_init(TIM2_ENCODER,TIM2_ENCODER_CH1_P33_7,TIM2_ENCODER_CH2_P33_6);   //左编码器
...
void ReadEncoder(void){
    ...
    l_temp=-encoder_get_count(TIM2_ENCODER);    //读左编码器
    r_temp=encoder_get_count(TIM6_ENCODER);    //读右编码器
